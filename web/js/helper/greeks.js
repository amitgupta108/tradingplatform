...
function addIVNDelta(q, uq)
{
    ...
    {    
        ...
        try{
            var iv = js_vollib.black.implied_volatility.implied_volatility(q.ltp, uq, Number(q.strike_price), 0.005, yearsToExpiry, flag);
            var delta = js_vollib.black.greeks.analytical.delta(flag, uq, Number(q.strike_price), 0.005, yearsToExpiry, iv);   
