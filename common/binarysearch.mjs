...
class QuoteComparator {
   ...
   */
  constructor() {
    this.compare = QuoteComparator.defaultCompareFunction;
  }
   ...
   */
  lessThanOrEqual(q, t) {
    return this.lessThan(q, t) || this.equal(q, t);
  }
   ...
   * @return {boolean}
   */
  greaterThanOrEqual(q, t) {
    return this.greaterThan(q, t) || this.equal(q, t);
  }
